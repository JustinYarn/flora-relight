...
export async function POST(req: NextRequest): Promise<NextResponse> {
  ...
  if (
    ...
    (execution.executionId !== `lamp:${body.runId}` &&
      ...
      execution.executionId !== `lamp-iris:${body.runId}`) ||
    ...
    return NextResponse.json(
      {
        error:
          "Only a single-run Lamp, Lamp Background, Lamp Beautify, or Lamp Iris execution can acknowledge a lost generation here.",
      },
