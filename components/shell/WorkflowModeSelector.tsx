...
/**
 * Temporary unified setup surface used during the branch merge. Version A
 * replaces the single-mode header with the real workflow tabs; the Lamp
 * strength control remains scoped to Lamp and freezes into the next run.
 */
    ...
    >
      <div className="rounded-lg bg-surface px-3 py-2 text-left shadow-[0_1px_2px_rgba(0,0,0,0.28),0_0_0_1px_rgba(255,255,255,0.06)]">
        ...
        <span className="mt-0.5 block text-2xs text-muted">
          Exact two-pass relight
        </span>
      </div>
      <p className="px-2 pb-2 pt-2.5 text-pretty text-2xs leading-relaxed text-muted">
        <span className="font-medium text-ink">Lamp:</span> Generate Initial,
        critique the whole video once, regenerate Final from the source, then
        grade it blind before comparing with AI.
      </p>
